...
def modifying(tokens, dictionary):
    ...
    for i, word in enumerate(tokens):
        ...
        # we will first remove those characters, including '!"#$%&\'()*+,-./:;<=>?@[\\]^_`{|}~' and '\n'
        ...
        # check the spelling, if it is not correct, we will find a replaced one
    ...
    # we assume the first character in a text is a capital letter
    # in case the first word is mis-spelled
    # we will capitalize the first letter of the first word because all words
